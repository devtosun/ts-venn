...
function createSlot4(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime14.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React14.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  const Slot8 = createSlot4(`Primitive.${node}`);
...
var PopperAnchor = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime16.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React18.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime17.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React18.isValidElement(newElement) ? React18.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React18.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
function dispatchDiscreteCustomEvent(target, event) {
  if (target) ReactDOM5.flushSync(() => target.dispatchEvent(event));
}
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React21.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime20.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React21.isValidElement(newElement) ? React21.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  const Slot8 = createSlot6(`Primitive.${node}`);
  const Node2 = React23.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot8 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime23.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime23.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime23.jsx)(PortalProvider, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime23.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime23.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var Slot7 = createSlot5("MenuContent.ScrollLock");
var MenuContentImpl = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const scrollLockWrapperProps = disableOutsideScroll ? { as: Slot7, allowPinchZoom: true } : void 0;
...
var MenuGroup = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive4.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime23.jsx)(Primitive4.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime24.jsx)(Portal2, { ...menuScope, ...portalProps });
};
